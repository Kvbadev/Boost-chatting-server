...
private:
    ...
    void send_msg_length(int l, std::string c){
    ...
    void get_msg_length(){
        ...
        boost::asio::async_read(socket_, boost::asio::buffer(x, 2), 
    ...
    void get_msg_length_handler(const boost::system::error_code &e, size_t, boost::array<char, 4>* x){
        try{
            std::string b;
